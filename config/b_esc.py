model = dict(
    ...
    backbone=dict(
		type='CTRGCN',
        graph_cfg=dict(layout='esc_coco21', mode='spatial')),
    cls_head=dict(type='GCNHead', num_classes=9, in_channels=256))

dataset_type = 'PoseDataset'
ann_file = "/home/ps/pyskl-main/data/esc_futi_train.pkl"
train_pipeline = [
    dict(type='PreNormalize2D'),
    dict(type='MergeEscKeypoint'),                
    dict(type='GenSkeFeat', dataset='esc_coco21', feats=['b']),
